...
\title{On Empirically Studying ``Snapshots'' of Software Development Social Communities}
...
The study resulted in ODeSSA, a semi-automatic method for Outlining Development Social Structures to Analyse. ODeSSA allows the observers of a social structure (more simply, a community) to capture it in the form of analysable ``\emph{snapshots}''. A community \emph{\emph{snapshot}} is obtained by combining: (a) answers to a questionnaire (see Fig. \ref{question} also available online\footnote{\url{https://docs.google.com/document/d/1lZ2IrQzd3uBqk4eivqA6RStiquzImxEETbdtCKRdHjY/edit}}); (b) visits to a decision-tree (previously introduced in \cite{specissue}). Figure \ref{snapshot} outlines our idea of a snapshot.
%
...
%\hspace{-.6cm}
%\begin{sideways}
\includegraphics[width=3.5in]{snapshot}%
%\end{sideways}
\caption{snapshot for development communities.}\label{snapshot}
\end{figure}
...
\begin{table*}
\begin{tabular}{|l|>{\raggedright}p{3cm}|>{\raggedright}p{13cm}|}
\hline 
\textbf{Label} & \textbf{Name} & \textbf{Description}\tabularnewline
\hline 
COP & Communities of practice & A CoP consists of groups of people who share a concern, a set of problems,
or a passion about a topic or practice. These people deepen their knowledge and expertise
in their topic or practice by interacting frequently, face-to-face, collaboratively (helping each other) and constructively (to increase their mutual knowledge). This set of social processes and conditions is called situatedness \cite{situated,Ruikar2009}.\tabularnewline
\hline 
IN & Informal Networks & INs can be seen as loose networks of ties between individuals that
...
\hline 
FN & Formal Networks & Within FNs, members are rigorously selected and prescribed. They are
...
\hline 
IC & Informal Communities & ICs are usually sets of people part of an organisation, with a common
...
\hline 
NOP & Networks of Practice & A NoP is a networked system of communication and collaboration that
...
\hline 
WG & Workgroups & WG are groups of technical experts whose goals span an entire business area or array of
...
\hline 
PT & Project-Teams & PTs are made by people with complementary skills who work together
...
\hline 
SC & Strategic Communities & SCs consist of meticulously selected people, experts in certain sectors
...
\hline 
FG & Formal Groups & FGs are comprised of people which are explicitly grouped by corporations
...
\hline 
PSC & Problem-solving Communities & PSCs can be seen as a specific instance of a Strategic Community focused
...
\hline 
LC & Learning Communities & LCs provide a space for pure learning and explicit sharing of actionable
...
\hline 
KC & Knowledge Networks & Essentially KCs are groups of people with a shared passion to create,
use, and share new knowledge for tangible business purposes (e.g.
increased sales, increased product offer, clients profiling, etc.).
...
\hline 
SN & Social Networks & SNs represent the emergent network of social ties spontaneously arising
...
\end{center}
Previous research in organisational studies, social-networks analysis (SNA) and software engineering, suggest there are many variables at play within a software development community. In previous research \cite{ossslr,specissue}, we provided an extensive list of attributes that define community types. Table \ref{commtypes} provides an overview of community types. These types were obtained through a Systematic Literature Review on organisations and social-networks research \cite{ossslr}. In this work we investigated a big, real-life software development organisation, to identify which information is essential to define a \emph{snapshot} for an observed organisation. By examining interviews and other sources of organisational evidence, we found a way to represent a \emph{snapshot} of an observed community, such that the \emph{snapshot} can be further analysed.
...
The rest of the paper is structured as follows: Section \ref{mm} explains materials and methods; Section \ref{cs} presents the case-study, while Section \ref{res} discusses results. Finally, Section \ref{conc} concludes the paper with future work.
...
We noticed immediately that the method in \cite{specissue} works best to identify a single observable community. The case-study we used in \cite{specissue} to validate our decision-tree didn't uncover this limitation, perhaps given its much smaller size.
...
The authors would like to thank Dr. Ossi Korhonen and Dr. Minna Raisanen for providing empirical evidence in the form of well-defined reports, for us to elaborate the results in this paper. We acknowledge the contribution of all employees in Company X that offered their time to confirm the results contained in this paper. 
%Finally, the authors would like to thank beer, Mrs. Mirella Sangiovanni's home-made sweets and her mother's home-made cheese for sustaining the authors along the elaboration of the case-study.
