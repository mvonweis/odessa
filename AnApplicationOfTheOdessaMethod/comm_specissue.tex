...
Digging deeper in the data, we found that the first point, DISPERSION identifies a sub-community. The second point was identified as an inconsistency by our industrial partner.
...
\emph{Pivots} however, were not explicit in our questionnaire. Rather they resided in the multiple versions of the same questionnaire, answered with different sets of data. We decided at this point, to use a Checklist, as a mechanism to make \emph{Pivots} explicit.
