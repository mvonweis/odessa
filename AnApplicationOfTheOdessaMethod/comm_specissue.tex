...
Inheriting from strategic evaluation approaches such as \cite{swot}, we elaborated an initial analysis framework for SEEDS \emph{\emph{snapshots}}. To understand strengths, weaknesses, opportunities and threats analysing community properties using SEEDS \emph{\emph{snapshots}}, there are three key dimensions that must be evaluated. 
...
First, SEEDS \emph{\emph{snapshots}} can assume three possible forms:
