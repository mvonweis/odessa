...
Figure \ref{odessa} provides an overview of OdeSSA. The method starts by using the questionnaire, proceeds by applying a checklist and map results to a decision-tree. Finally, the method allows analysis and action on the obtained snapshot.
...
\begin{tabular}{|>{\raggedright}p{10cm}|>{\raggedright}p{1.5cm}|}
\hline 
...
%  \begin{center}
    \includegraphics[width=0.35\textwidth]{checklist.pdf}    %
%  \end{center}
\vspace{-.3cm}
...
%The properties of the obtained \emph{\emph{snapshot}} must be evaluated using the forms presented in Section \ref{res}.


we found that ODeSSA \emph{\emph{snapshot}s} can assume four possible forms: 
\begin{enumerate}
