...
This led us to switching our course of action. Rather than visiting the decision-tree top-down, looking for data to answer each node, we prepared a list of questions representing nodes in the decision-tree. Analysing available data twice, we were able to exactly pinpoint areas of text explicitly and unmistakably answering questions. This delayed decision-tree visits until data was properly organised in a questionnaire.
...
Our data also leads to the presence of additional ``enriching'' attributes for Company X, namely GOVERNANCE practices and DURATION.
...
Finally, inspecting the decision-tree, we also found that it can be divided in three higher-order sets, or areas. 
...
The three areas or ``foci'' above, are higher-order properties of your community. 
