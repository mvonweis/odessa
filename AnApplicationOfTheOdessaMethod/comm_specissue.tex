...
% MARTIN COMMENT: I find that the following paragraphs (down to the list of decision nodes) could use a rewrite, as there's some repetition and lack of clarity. This is not a critical problem.
