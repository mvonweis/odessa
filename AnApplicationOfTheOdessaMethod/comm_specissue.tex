...
One of the organisational coaches in the case organisation was able to give continuous feedback throughout the research and the writing of this report. This person clarified the structures and working modes inside Company X and provided deeper insight into one of the departments.
...
to interpret this data, we initially tried to visit the decision-tree in a top-down fashion. Given the sheer amount and disorganisation of data, immediately we found that this approach was not working.

This led us to switching our course of action. Rather than visiting the decision-tree top-down, looking for data to answer each node, we prepared a list of questions representing nodes in the decision-tree. This allowed us to ``visit'' all nodes in parallel, delaying the decision-tree until data was properly organised in a questionnaire. Analysing available data twice, we were able to exactly pinpoint areas of text explicitly and unmistakably answering questions. This delayed
...
Answers to this questionnaire are summarised on Table \ref{questionnaire1} for Study 1, and on Table~\ref{questionnaire2} for Study 2. Column 1 reports the question needed to gather necessary information. Column 2 presents answers that we found in our two studies.
